...
" Syntax: Strings {{{2
syn region  jsonStringDQ  start=+"+  skip=+\\\\\|\\"+  end=+"+  contains=jsonEscape
...
if version >= 508 || !exists("did_json_syn_inits")
  ...
  HiLink jsonStringDQ           String
  HiLink jsonStringSQ           String
  HiLink jsonEscape             Special
  HiLink jsonNumber             Number
  HiLink jsonBraces             Operator
  HiLink jsonNull               Identifier
  HiLink jsonBoolean            Identifier
